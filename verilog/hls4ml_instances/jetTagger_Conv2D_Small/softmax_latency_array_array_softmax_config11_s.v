...
module softmax_latency_array_array_softmax_config11_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
softmax_latency_array_array_softmax_config11_s_exp_table #(
    .DataWidth( 18 ),
    .AddressRange( 1024 ),
    .AddressWidth( 10 ))
exp_table_U(
...
softmax_latency_array_array_softmax_config11_s_invert_tabbkb #(
    .DataWidth( 14 ),
    .AddressRange( 1024 ),
    .AddressWidth( 10 ))
invert_table7_U(
...
endmodule //softmax_latency_array_array_softmax_config11_s
