...
reg   [0:0] tmp_reg_397_pp0_iter1_reg;
...
wire   [9:0] i_4_fu_239_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [7:0] tmp_data_0_V_fu_283_p3;
wire   [7:0] tmp_data_1_V_fu_298_p3;
wire   [7:0] tmp_data_2_V_fu_313_p3;
wire   [7:0] tmp_data_3_V_fu_328_p3;
wire   [7:0] tmp_data_4_V_fu_343_p3;
wire   [7:0] tmp_data_5_V_fu_358_p3;
wire   [7:0] tmp_data_6_V_fu_373_p3;
wire   [7:0] tmp_data_7_V_fu_388_p3;
reg    ap_block_state1;
...
wire   [0:0] tmp_11_1_fu_292_p2;
wire   [0:0] tmp_11_2_fu_307_p2;
wire   [0:0] tmp_11_3_fu_322_p2;
wire   [0:0] tmp_11_4_fu_337_p2;
wire   [0:0] tmp_11_5_fu_352_p2;
wire   [0:0] tmp_11_6_fu_367_p2;
wire   [0:0] tmp_11_7_fu_382_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((res_V_data_0_V_1_ack_in == 1'b0) | (res_V_data_7_V_1_ack_in == 1'b0) | (res_V_data_6_V_1_ack_in == 1'b0) | (res_V_data_5_V_1_ack_in == 1'b0) | (res_V_data_4_V_1_ack_in == 1'b0) | (res_V_data_3_V_1_ack_in == 1'b0) | (res_V_data_2_V_1_ack_in == 1'b0) | (res_V_data_1_V_1_ack_in == 1'b0)) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_233_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_reg_222 <= i_4_fu_239_p2;
    end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_reg_222 <= 10'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((res_V_data_0_V_1_load_A == 1'b1)) begin
        res_V_data_0_V_1_payload_A <= tmp_data_0_V_fu_283_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_0_V_1_load_B == 1'b1)) begin
        res_V_data_0_V_1_payload_B <= tmp_data_0_V_fu_283_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_1_V_1_load_A == 1'b1)) begin
        res_V_data_1_V_1_payload_A <= tmp_data_1_V_fu_298_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_1_V_1_load_B == 1'b1)) begin
        res_V_data_1_V_1_payload_B <= tmp_data_1_V_fu_298_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_2_V_1_load_A == 1'b1)) begin
        res_V_data_2_V_1_payload_A <= tmp_data_2_V_fu_313_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_2_V_1_load_B == 1'b1)) begin
        res_V_data_2_V_1_payload_B <= tmp_data_2_V_fu_313_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_3_V_1_load_A == 1'b1)) begin
        res_V_data_3_V_1_payload_A <= tmp_data_3_V_fu_328_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_3_V_1_load_B == 1'b1)) begin
        res_V_data_3_V_1_payload_B <= tmp_data_3_V_fu_328_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_4_V_1_load_A == 1'b1)) begin
        res_V_data_4_V_1_payload_A <= tmp_data_4_V_fu_343_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_4_V_1_load_B == 1'b1)) begin
        res_V_data_4_V_1_payload_B <= tmp_data_4_V_fu_343_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_5_V_1_load_A == 1'b1)) begin
        res_V_data_5_V_1_payload_A <= tmp_data_5_V_fu_358_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_5_V_1_load_B == 1'b1)) begin
        res_V_data_5_V_1_payload_B <= tmp_data_5_V_fu_358_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_6_V_1_load_A == 1'b1)) begin
        res_V_data_6_V_1_payload_A <= tmp_data_6_V_fu_373_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_6_V_1_load_B == 1'b1)) begin
        res_V_data_6_V_1_payload_B <= tmp_data_6_V_fu_373_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_7_V_1_load_A == 1'b1)) begin
        res_V_data_7_V_1_payload_A <= tmp_data_7_V_fu_388_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((res_V_data_7_V_1_load_B == 1'b1)) begin
        res_V_data_7_V_1_payload_B <= tmp_data_7_V_fu_388_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_reg_397 <= tmp_fu_233_p2;
        tmp_reg_397_pp0_iter1_reg <= tmp_reg_397;
    end
end

always @ (*) begin
    if ((tmp_fu_233_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((~((res_V_data_0_V_1_ack_in == 1'b0) | (res_V_data_7_V_1_ack_in == 1'b0) | (res_V_data_6_V_1_ack_in == 1'b0) | (res_V_data_5_V_1_ack_in == 1'b0) | (res_V_data_4_V_1_ack_in == 1'b0) | (res_V_data_3_V_1_ack_in == 1'b0) | (res_V_data_2_V_1_ack_in == 1'b0) | (res_V_data_1_V_1_ack_in == 1'b0)) & (1'b1 == ap_CS_fsm_state5))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((tmp_reg_397 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((tmp_reg_397 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((tmp_reg_397_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((tmp_reg_397 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((tmp_fu_233_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((tmp_fu_233_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((tmp_reg_397 == 1'd0) & (data_V_data_0_V0_status == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((tmp_reg_397 == 1'd0) & (data_V_data_0_V0_status == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((tmp_reg_397 == 1'd0) & (data_V_data_0_V0_status == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state3_io = ((tmp_reg_397 == 1'd0) & (res_V_data_0_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((tmp_reg_397 == 1'd0) & (data_V_data_0_V0_status == 1'b0));
end

always @ (*) begin
    ap_block_state4_io = ((tmp_reg_397_pp0_iter1_reg == 1'd0) & (res_V_data_0_V_1_ack_in == 1'b0));
end

assign ap_block_state4_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state5 = ((res_V_data_0_V_1_ack_in == 1'b0) | (res_V_data_7_V_1_ack_in == 1'b0) | (res_V_data_6_V_1_ack_in == 1'b0) | (res_V_data_5_V_1_ack_in == 1'b0) | (res_V_data_4_V_1_ack_in == 1'b0) | (res_V_data_3_V_1_ack_in == 1'b0) | (res_V_data_2_V_1_ack_in == 1'b0) | (res_V_data_1_V_1_ack_in == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign data_V_data_0_V0_status = (data_V_data_7_V_empty_n & data_V_data_6_V_empty_n & data_V_data_5_V_empty_n & data_V_data_4_V_empty_n & data_V_data_3_V_empty_n & data_V_data_2_V_empty_n & data_V_data_1_V_empty_n & data_V_data_0_V_empty_n);
...
assign i_4_fu_239_p2 = (i_reg_222 + 10'd1);
...
assign tmp_11_1_fu_292_p2 = (($signed(data_V_data_1_V_dout) > $signed(8'd0)) ? 1'b1 : 1'b0);

assign tmp_11_2_fu_307_p2 = (($signed(data_V_data_2_V_dout) > $signed(8'd0)) ? 1'b1 : 1'b0);

assign tmp_11_3_fu_322_p2 = (($signed(data_V_data_3_V_dout) > $signed(8'd0)) ? 1'b1 : 1'b0);

assign tmp_11_4_fu_337_p2 = (($signed(data_V_data_4_V_dout) > $signed(8'd0)) ? 1'b1 : 1'b0);

assign tmp_11_5_fu_352_p2 = (($signed(data_V_data_5_V_dout) > $signed(8'd0)) ? 1'b1 : 1'b0);

assign tmp_11_6_fu_367_p2 = (($signed(data_V_data_6_V_dout) > $signed(8'd0)) ? 1'b1 : 1'b0);

assign tmp_11_7_fu_382_p2 = (($signed(data_V_data_7_V_dout) > $signed(8'd0)) ? 1'b1 : 1'b0);

assign tmp_data_0_V_fu_283_p3 = ((tmp_s_fu_277_p2[0:0] === 1'b1) ? data_V_data_0_V_dout : 8'd0);

assign tmp_data_1_V_fu_298_p3 = ((tmp_11_1_fu_292_p2[0:0] === 1'b1) ? data_V_data_1_V_dout : 8'd0);

assign tmp_data_2_V_fu_313_p3 = ((tmp_11_2_fu_307_p2[0:0] === 1'b1) ? data_V_data_2_V_dout : 8'd0);

assign tmp_data_3_V_fu_328_p3 = ((tmp_11_3_fu_322_p2[0:0] === 1'b1) ? data_V_data_3_V_dout : 8'd0);

assign tmp_data_4_V_fu_343_p3 = ((tmp_11_4_fu_337_p2[0:0] === 1'b1) ? data_V_data_4_V_dout : 8'd0);

assign tmp_data_5_V_fu_358_p3 = ((tmp_11_5_fu_352_p2[0:0] === 1'b1) ? data_V_data_5_V_dout : 8'd0);

assign tmp_data_6_V_fu_373_p3 = ((tmp_11_6_fu_367_p2[0:0] === 1'b1) ? data_V_data_6_V_dout : 8'd0);

assign tmp_data_7_V_fu_388_p3 = ((tmp_11_7_fu_382_p2[0:0] === 1'b1) ? data_V_data_7_V_dout : 8'd0);

assign tmp_fu_233_p2 = ((i_reg_222 == 10'd784) ? 1'b1 : 1'b0);

assign tmp_s_fu_277_p2 = (($signed(data_V_data_0_V_dout) > $signed(8'd0)) ? 1'b1 : 1'b0);
