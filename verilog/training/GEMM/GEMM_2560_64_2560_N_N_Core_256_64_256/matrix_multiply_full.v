...
reg   [14:0] indvar_flatten_reg_7739;
...
wire   [14:0] indvar_flatten_next_fu_7778_p2;
...
wire   [14:0] tmp_fu_9149_p3;
wire   [15:0] tmp_cast_fu_9160_p1;
wire   [15:0] tmp_21_cast_fu_9156_p1;
wire   [15:0] tmp_18_fu_9163_p2;
...
assign exitcond_flatten_fu_7772_p2 = ((indvar_flatten_reg_7739 == 15'd16384) ? 1'b1 : 1'b0);

assign exitcond_fu_7790_p2 = ((Col_assign_reg_7761 == 7'd64) ? 1'b1 : 1'b0);

assign indvar_flatten_next_fu_7778_p2 = (indvar_flatten_reg_7739 + 15'd1);
