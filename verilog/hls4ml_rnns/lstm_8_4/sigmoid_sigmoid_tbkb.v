...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module sigmoid_sigmoid_tbkb_rom (
...
initial begin
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram0);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram1);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram2);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram3);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram4);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram5);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram6);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram7);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram8);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram9);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram10);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram11);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram12);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram13);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram14);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram15);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram16);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram17);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram18);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram19);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram20);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram21);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram22);
    $readmemh("./sigmoid_sigmoid_tbkb_rom.dat", ram23);
end
...
sigmoid_sigmoid_tbkb_rom sigmoid_sigmoid_tbkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
