...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module softmax_invert_tadEe_rom (
...
initial begin
    $readmemh("./softmax_invert_tadEe_rom.dat", ram0);
    $readmemh("./softmax_invert_tadEe_rom.dat", ram1);
    $readmemh("./softmax_invert_tadEe_rom.dat", ram2);
end
...
softmax_invert_tadEe_rom softmax_invert_tadEe_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
